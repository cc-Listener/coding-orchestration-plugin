...
- `orchestrator.py` 目前仍是唯一核心大文件债务，当前约 1370 行；Task 37 的长期目标是继续按低耦合、高内聚切片把 façade 缩到 500 行左右，不把 runner/workspace/git/run lifecycle 核心实现粗暴搬迁。
