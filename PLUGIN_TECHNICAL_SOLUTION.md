...
- `orchestrator.py` 已从核心大文件债务降到约 467 行；Task 37 的 500 行治理目标已达成。后续若继续拆 run lifecycle、runner/workspace/git 或 host bootstrap，应作为新的低耦合切片处理，不粗暴搬迁核心实现。
